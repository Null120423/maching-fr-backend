...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<hello.HelloRequest,
      hello.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = hello.HelloRequest.class,
      responseType = hello.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<hello.HelloRequest,
      hello.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<hello.HelloRequest, hello.HelloReply> getSayHelloMethod;
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(hello.HelloRequest request,
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return hello.HelloProto.getDescriptor();
    }
